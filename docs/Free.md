...
این آموزش ساده ترین روش اتصال به اینترنت آزاد در ویندوز هست
...
استحضار دارید که ساب‌ها فقط روی خطوط مخابرات و ایرانسل کار می‌کنند.
برای همراه اول فعلاً این ساب تست در دسترس شماست:

https://serverv.net/mci-test.json

(از پریروز ۱۰ بار سرور و IP عوض کردم. فعلاً با این کارها زنده‌س 🤦‍♂️)

✅ سرورهای ساب‌ها یک ماه دیگه تمدید شد.
رفتیم برای ماه سوم.
با هر بار اتصال به یه سرور جدید وصل میشین.

با ۳۰۰ ساب شروع کردیم، الان ۱۵۰۰ نفر ساب دارن. ولی بر اساس ترافیک سرورها فکر کنم ۳۰۰۰ تا ۵۰۰۰ نفر دارن استفاده می‌کنن.

با کمال میل، هزینه‌ها را پرداخت کرده‌ام.
اسپانسر نداریم، نه اینوری نه اونوری 😁
...
یه سری مشکلات داشت این ساب حل شد
برای جاهایی که نیاز به آی پی ثابت و تمیز دارید عالیه
...
توسط کانفیگ فرگمنت GFW-knocker به سرور VPN وصل نمی‌شید و صرفا فیلترینگ (https://twitter.com/hashtag/%D9%81%DB%8C%D9%84%D8%AA%D8%B1%DB%8C%D9%86%DA%AF) یوتیوب، توییتر و اینستاگرام رو بی‌اثر میکنه. بنابراین آی‌پی شما، آی‌پی ایران خودتون هست و اگر قصد مخفی‌نگه‌داشتن هویتتون رو دارین باید به این‌نکته توجه داشته باشین. همونطور که در استفاده از واتس‌اپ که دیروز کمر رستم رو براش شکستن و رفع فیلتر کردن، به‌همین مساله لازمه دقت کنید!
